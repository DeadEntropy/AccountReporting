...
class PayrollData:
    ...
    def waterfall_chart(self):
        ...
        _y = [self.earnings, self.taxable_benefits,  -self.pre_tax_deductions,  -self.taxes,  -self.post_tax_deductions,  self.reimbursements, self.net_pay]
...
def waterfall_chart(payroll, inflows):
        ...
        _y = [payroll.earnings, payroll.taxable_benefits,  -payroll.pre_tax_deductions,  -payroll.taxes,  -payroll.post_tax_deductions,  payroll.reimbursements, payroll.net_pay]
